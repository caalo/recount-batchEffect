...
analyzeMultipleStudies = function(mods, geneCounts, studyNames, forcedNumSV, logPlot = F) {
  ...
  mods2$`(Intercept)` = as.factor(mods2$`(Intercept)`)
  mods2$caseStatusTRUE = as.factor(mods2$caseStatusTRUE)
  ...
  #Infer SV
  nullMods = as.matrix(mods[, 1])
  svobj = sva(geneCountsNormalized, mods, nullMods, n.sv = n.sv, vfilter = 3000)
  forced_svobj = sva(geneCountsNormalized, mods, nullMods, n.sv = forcedNumSV, vfilter = 3000)
  
  return(list(svobj = svobj,
              forced_svobj = forced_svobj))
}
```
...
for(i in 1:nrow(study_info)) {
  ...
  if(i == 1)
    expected_multiStudy_SV = study_i$svobj$n.sv
  if(i > 1) {
    expected_multiStudy_SV = expected_multiStudy_SV + study_i$svobj$n.sv + 1
    ...
    multiStudy_forced_SV[[i]] = multiStudy_i$forced_svobj
  }
}
```
...
#study 1 and 2 vs. merged study 1 and 2
...
myPairs = function(df1, df2, top = "", bottom = "", left = "") {
...
myPairs(singleStudy_SV[[1]]$sv, multiStudy2SV1, top = "Study 1 SVs vs. Study 1+2 SVs", left = "Study 1", bottom = "Study 1 + 2")
myPairs(singleStudy_SV[[1]]$sv, multiStudy2ForcedSV1, "Study 1 SVs vs. Study 1+2 forced SVs", left = "Study 1", bottom = "Study 1 + 2")

myPairs(singleStudy_SV[[2]]$sv, multiStudy2SV2, top = "Study 2 SVs vs. Study 1+2 SVs", left = "Study 2", bottom = "Study 1 + 2")
myPairs(singleStudy_SV[[2]]$sv, multiStudy2ForcedSV2, top = "Study 2 SVs vs. Study 1+2 forced SVs", left = "Study 2", bottom = "Study 1 + 2")


myPairs(singleStudy_SV[[1]]$sv, data.frame(multiStudy3SV1), top = "Study 1 SVs vs. Study 1+2+3 SVs", left = "Study 1", bottom = "Study 1 + 2 + 3")
myPairs(singleStudy_SV[[1]]$sv, multiStudy3ForcedSV1, "Study 1 SVs vs. Study 1+2+3 forced SVs", left = "Study 1", bottom = "Study 1 + 2 + 3")

myPairs(singleStudy_SV[[2]]$sv, data.frame(multiStudy3SV2), top = "Study 2 SVs vs. Study 1+2+3 SVs", left = "Study 2", bottom = "Study 1 + 2 + 3")
myPairs(singleStudy_SV[[2]]$sv, multiStudy3ForcedSV2, top = "Study 2 SVs vs. Study 1+2+3 forced SVs", left = "Study 2", bottom = "Study 1 + 2 + 3")

myPairs(singleStudy_SV[[3]]$sv, data.frame(multiStudy3SV3), top = "Study 3 SVs vs. Study 1+2+3 SVs", left = "Study 3", bottom = "Study 1 + 2 + 3")
myPairs(singleStudy_SV[[3]]$sv, multiStudy3ForcedSV3, top = "Study 3 SVs vs. Study 1+2+3 forced SVs", left = "Study 3", bottom = "Study 1 + 2 + 3")



myPairs(singleStudy_SV[[1]]$sv, multiStudy4SV1, top = "Study 1 SVs vs. Study 1+2+3+4 SVs", left = "Study 1", bottom = "Study 1 + 2 + 3 + 4")
myPairs(singleStudy_SV[[1]]$sv, multiStudy4ForcedSV1, "Study 1 SVs vs. Study 1+2+3+4 forced SVs", left = "Study 1", bottom = "Study 1 + 2 + 3 + 4")

myPairs(singleStudy_SV[[2]]$sv, multiStudy4SV2, top = "Study 2 SVs vs. Study 1+2+3+4 SVs", left = "Study 2", bottom = "Study 1 + 2 + 3 + 4")
myPairs(singleStudy_SV[[2]]$sv, multiStudy4ForcedSV2, top = "Study 2 SVs vs. Study 1+2+3+4 forced SVs", left = "Study 2", bottom = "Study 1 + 2 + 3 + 4")

myPairs(singleStudy_SV[[3]]$sv, multiStudy4SV3, top = "Study 3 SVs vs. Study 1+2+3+4 SVs", left = "Study 3", bottom = "Study 1 + 2 + 3 + 4")
myPairs(singleStudy_SV[[3]]$sv, multiStudy4ForcedSV3, top = "Study 3 SVs vs. Study 1+2+3+4 forced SVs", left = "Study 3", bottom = "Study 1 + 2 + 3 + 4")

myPairs(singleStudy_SV[[4]]$sv, multiStudy4SV4, top = "Study 4 SVs vs. Study 1+2+3+4 SVs", left = "Study 4", bottom = "Study 1 + 2 + 3 + 4")
myPairs(singleStudy_SV[[4]]$sv, multiStudy4ForcedSV4, top = "Study 4 SVs vs. Study 1+2+3+4 forced SVs", left = "Study 4", bottom = "Study 1 + 2 + 3 + 4")
